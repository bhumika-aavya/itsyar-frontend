...
import { LayoutDashboard, Scale, ListChecks, User, LogOut, ChevronDown, Award } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen bg-[#F9FAFD]">
      ...
      <aside className="w-64 bg-white border-r border-slate-100 p-6 flex flex-col sticky top-0 h-screen">
        <div className="flex items-center gap-2 mb-2 px-2 cursor-pointer" onClick={() => navigate('/judge')}>
        ...
        <div className="mx-2 mb-8">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-amber-50 rounded-lg">
            ...
            <span className="text-[11px] font-extrabold text-amber-600 uppercase tracking-widest">Judge Panel</span>
          </span>
        </div>
