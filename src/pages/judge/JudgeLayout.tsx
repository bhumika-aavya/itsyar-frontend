    ...
    <div className="flex min-h-screen bg-[#F9FAFD]">
      ...
      <aside className="w-64 bg-white border-r border-slate-100 p-6 flex flex-col sticky top-0 h-screen">
        ...
        <div className="mx-2 mb-8">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-amber-50 rounded-lg">
            ...
            <span className="text-[11px] font-black text-amber-600 uppercase tracking-widest">Judge Panel</span>
          </span>
        </div>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white border-b border-slate-100 flex items-center justify-between px-8 sticky top-0 z-40">
          <div>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-0.5">Judge</p>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="w-9 h-9 rounded-full bg-amber-50 flex items-center justify-center">
                <span className="text-amber-600 font-black text-sm uppercase">
                  {user?.fullName?.charAt(0) || 'J'}
                </span>
              </div>
              <div className="text-right hidden sm:block">
                <div className="text-sm font-bold text-slate-900 leading-tight">{user?.fullName || 'Judge'}</div>
                <div className="text-[10px] font-black text-amber-600 uppercase tracking-widest">Judge</div>
              </div>
