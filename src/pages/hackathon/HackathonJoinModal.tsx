                    ...
                    <>
                        ...
                        <div className="flex gap-3 px-7 py-5 border-t border-slate-50">
                            ...
                            <button
                                ...
                                className="flex-1 py-3 bg-[#4F46E5] text-white rounded-xl font-extrabold text-sm shadow-lg shadow-indigo-100 dark:shadow-none hover:bg-[#4338CA] disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                            >
                                Continue
                            </button>
                        </div>
                ...
                {step === 'team-created' && (
                    <div className="px-7 py-10 flex flex-col items-center text-center space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-3.5 bg-[#4F46E5] text-white rounded-2xl font-extrabold text-sm shadow-lg shadow-indigo-100 dark:shadow-none hover:bg-[#4338CA] transition-all mt-2"
                        >
                            Go to Hackathon
                        </button>
                    </div>
