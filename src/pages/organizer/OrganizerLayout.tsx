        ...
        <header className="h-16 bg-white dark:bg-[#16171d] border-b border-slate-100 dark:border-[#2e303a] flex items-center justify-between px-8 shrink-0 z-40">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <div className="w-9 h-9 rounded-full bg-emerald-50 dark:bg-emerald-950/50 border border-transparent dark:border-[#2e303a] flex items-center justify-center">
                  <span className="text-emerald-600 dark:text-emerald-400 font-extrabold text-sm uppercase">
                    {user?.fullName?.charAt(0) || 'O'}
                  </span>
                </div>
                <div className="text-right hidden sm:block">
                  <div className="text-sm font-bold text-slate-900 dark:text-slate-100 leading-tight">{user?.fullName || 'Organizer'}</div>
                  <div className="text-[10px] font-extrabold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Organizer</div>
                </div>
