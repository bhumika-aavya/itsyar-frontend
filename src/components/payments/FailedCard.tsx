        ...
        <div className="max-w-lg mx-auto text-center space-y-8 animate-in fade-in duration-500">
            ...
            <div className="space-y-3">
                <button
                    ...
                    className="w-full py-4 bg-[#4F46E5] text-white rounded-2xl font-extrabold text-sm shadow-xl shadow-indigo-100 dark:shadow-none hover:bg-[#4338CA] transition-all active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    {isRetryLoading ? (
                        <>
