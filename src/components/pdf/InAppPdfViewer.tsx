    ...
    >
      ...
      {isCaptureProtected && (
        <div className="absolute inset-0 z-40 bg-slate-950/95 backdrop-blur-3xl flex flex-col items-center justify-center text-center p-8 transition-opacity duration-150 animate-in fade-in duration-100">
          <div className="w-16 h-16 rounded-3xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 flex items-center justify-center mb-4 shadow-xl shadow-indigo-500 dark:shadow-none">
            <ShieldAlert size={32} />
          </div>
